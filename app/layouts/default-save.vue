        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center justify-start">
            ...
            <a href="/" class="text-xl font-bold flex items-center lg:ml-2.5">
              ...
              <span class="self-center whitespace-nowrap text-slate-600">วิทยาลัยอาชีวศึกษาร้อยเอ็ด<span
                  class="block text-sm text-slate-400 font-thin tracking-widest">Roi Et Vocational College</span></span>
            </a>
          </div>
