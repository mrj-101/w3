<template>
  <UContainer class="my-8 space-y-4">
    <!-- วิสัยทัศน์ พันธกิจ -->
    <div class="flex flex-col md:flex-row gap-4">
      <div class="flex-1 bg-white rounded-2xl p-4 text-center">
        <img src="/images/base/vision.gif" data-aos="zoom-out-down" alt="vision" class="w-72 rounded-sm mx-auto">
        <h3 class="font-extrabold my-2 text-2xl text-zinc-500">ปรัชญา</h3>
        <p>
          ทักษะฝีมือดี มีคุณธรรม นำชุมชนพัฒนา ก้าวหน้าทันเทคโนโลยี
        </p>
        <h3 class="font-extrabold my-2 text-2xl text-zinc-500">วิสัยทัศน์</h3>
        <p>
          มุ่งพัฒนาการศึกษาด้านอาชีวศึกษา ให้ผู้เรียนมีคุณธรรมนำความรู้<br />
          มีคุณภาพและศักยภาพได้มาตรฐานระดับสากล
        </p>
        <h3 class="font-extrabold my-2 text-2xl text-zinc-500">อัตลักษณ์</h3>
        <p>
          ผู้เรียนเป็นคนดี มีจิตบริการ
        </p>
        <h3 class="font-extrabold my-2 text-2xl text-zinc-500">เอกลักษณ์</h3>
        <p>
          เป็นสถานศึกษาสร้างคนดี บริการวิชาชีพสู่ชุมชน
        </p>
      </div>

      <div class="flex-1 bg-white rounded-2xl p-4 text-center">
        <img src="/images/base/mission.svg" data-aos="zoom-out-down" data-aos-anchor-placement="top-center" alt="vision"
          class="w-72 rounded-sm mx-auto">
        <h3 class="font-extrabold my-2 text-2xl text-zinc-500">พันธกิจ</h3>
        <ul class="text-start space-y-2 md:space-y-4 text-sm">
          <li class="list-decimal ms-6 border-b border-gray-100 mb-2 py-3">จัดการศึกษาประเภทวิชาพาณิชยกรรม คหกรรม
            ศิลปกรรม และอุตสาหกรรมการท่องเที่ยวให้ได้มาตรฐานวิชาชีพ โดยบริหารจัดการแบบมีส่วนร่วม
            ด้วยการสร้างความสัมพันธ์และความร่วมมืออันดีระหว่างสถานศึกษากับชุมชน</li>
          <li class="list-decimal ms-6 border-b border-gray-100 mb-2 py-3">จัดการเรียนการสอนแบบบูรณาการคุณธรรม จริยธรรม
            และคุณลักษณะอันพึงประสงค์ และมุ่งเน้นสมรรถนะอาชีพโดยยึดผู้เรียนเป็นสำคัญ</li>
          <li class="list-decimal ms-6 border-b border-gray-100 mb-2 py-3">จัดการเรียนการสอนให้สอดคล้องกับหลักสูตร
            ความต้องการของผู้เรียน สถานประกอบการและท้องถิ่น เพื่อเพิ่มศักยภาพการแข่งขันสู่ระดับสากล</li>
          <li class="list-decimal ms-6 border-b border-gray-100 mb-2 py-3">พัฒนาครู อาจารย์
            และบุคลากรทางการศึกษาให้มีคุณวุฒิ ความรู้ ความสามารถตรงกับงานที่รับผิดชอบอย่างมีประสิทธิภาพ</li>
          <li class="list-decimal ms-6 border-b border-gray-100 mb-2 py-3">พัฒนากระบวนการบริหารจัดการ
            มุ่งสู่ความเป็นผู้นำ เพื่อบริหารวิชาการ และวิชาชีพด้านอาชีวศึกษาและเทคโนโลยี</li>
          <li class="list-decimal ms-6 pt-3">พัฒนาการศึกษาในระดับปริญญาตรี</li>
        </ul>
      </div>
    </div>
    <!-- วิสัยทัศน์ พันธกิจ -->
    ...
    <div class="flex flex-col md:flex-row gap-4">
      <div class="flex-1 bg-white rounded-2xl p-4 text-center text-sm">
        ...
        <div class="py-3">
          ...
          ย้ายจากโรงเรียนฝึกหัดครูมูลร้อยเอ็ดมาอยู่ที่ดินของราชพัสดุมีเนื้อที่ 5 ไร่ 1 งาน 78.2 ตารางวา
        ...
        <ul>
          ...
          <li class="mb-3">
            <h3 class="font-bold text-zinc-500">พ.ศ. 2527</h3> เปิดสอนหลักสูตร ปวส. สาขาวิชาการบัญชี
          </li>
          <li class="mb-3">
          ...
          <li class="mb-3">
            ...
            และสาขาวิชาวิจิตรศิลป์ เปิดสอนหลักสูตร ปวส. สาขาวิชาคอมพิวเตอร์ธุรกิจ เปิดสอนหลักสูตร ปวส. (ม.6)
            สาขาวิชาการบัญชี และสาขาวิชาการตลาด
          </li>
          <li class="mb-3">
            <h3 class="font-bold text-zinc-500">พ.ศ. 2538</h3> เปิดสอนระบบทวิภาคี (ปวช.) สาขาธุรกิจค้าปลีก
            เปิดสอนหลักสูตร ปวช. ประเภทศิลปกรรม สาขาวิชาการออกแบบ
          </li>
          <li class="mb-3">
          ...
          <li class="mb-3">
            ...
            เปิดสอนระบบทวิภาคี (ปวช.) สาขาวิชาธุรกิจการโรงแรม
          </li>
          <li class="mb-3">
