...
import { useForwardPropsEmits, AccordionTrigger, AccordionItem, NavigationMenuItem, NavigationMenuTrigger, NavigationMenuLink, NavigationMenuContent, AccordionContent, AccordionRoot, NavigationMenuRoot, NavigationMenuList, NavigationMenuIndicator, NavigationMenuViewport, useForwardProps, DialogRoot, DialogTrigger, DialogPortal, DialogOverlay, DialogContent, VisuallyHidden, DialogTitle, DialogDescription, DialogClose, Primitive, Slot, TooltipRoot, TooltipTrigger, TooltipPortal, TooltipContent, TooltipArrow } from 'reka-ui';
import { A as serialize, p as publicAssetsURL, z as defu, B as parseQuery, C as isEqual, m as hasProtocol, j as joinURL, D as withTrailingSlash, E as withoutTrailingSlash, F as withLeadingSlash, G as parseURL, H as encodeParam, I as encodePath } from '../nitro/nitro.mjs';
import { reactivePick, createReusableTemplate, reactiveOmit, createSharedComposable } from '@vueuse/core';
import { h as useState, f as useAppConfig, e as useRoute, a as appConfig, b as useRouter, u as useNuxtApp, r as resolveRouteObject, c as useRuntimeConfig, n as navigateTo, g as useHead, d as nuxtLinkDefaults } from './server.mjs';
import { HoverCard, Popover } from 'reka-ui/namespaced';
import { createTV } from 'tailwind-variants';
import __nuxt_component_0$1 from './index-Dc-EbhPc.mjs';
...
const ipxRuntime$I2C3oPaaHEi5yogUdLHe0s_zL1Uk4LrRNcUfmJTmKuk = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  getImage,
  operationsGenerator,
  supportsAlias,
...
const imageOptions = {
  ...
  providers: {
    ["ipx"]: { provider: ipxRuntime$I2C3oPaaHEi5yogUdLHe0s_zL1Uk4LrRNcUfmJTmKuk, defaults: {} }
  }
};
...
const _sfc_main$7 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(props.chip ? _sfc_main$8 : unref(Primitive)), mergeProps({ as: __props.as }, props.chip ? typeof props.chip === "object" ? { inset: true, ...props.chip } : { inset: true } : {}, {
        class: ui.value.root({ class: [props.ui?.root, props.class] }),
        style: props.style
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
                    ...
                    if (_push3) {
                      ...
                      return [
                        renderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : "item-trailing", {
                          ...
                          __props.orientation === "horizontal" && (item.children?.length || !!slots[item.slot ? `${item.slot}-content` : "item-content"]) || __props.orientation === "vertical" && item.children?.length ? (openBlock(), createBlock(_sfc_main$9, {
                            key: 1,
                            name: item.trailingIcon || __props.trailingIcon || unref(appConfig2).ui.icons.chevronDown,
                            class: ui.value.linkTrailingIcon({ class: [props.ui?.linkTrailingIcon, item.ui?.linkTrailingIcon], active })
                          }, null, 8, ["name", "class"])) : item.trailingIcon ? (openBlock(), createBlock(_sfc_main$9, {
                            key: 2,
                            name: item.trailingIcon,
                            class: ui.value.linkTrailingIcon({ class: [props.ui?.linkTrailingIcon, item.ui?.linkTrailingIcon], active })
                          }, null, 8, ["name", "class"])) : createCommentVNode("", true)
            ...
            return [
              renderSlot(_ctx.$slots, item.slot || "item", {
                ...
                renderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : "item-leading", {
                  ...
                  item.avatar ? (openBlock(), createBlock(_sfc_main$7, mergeProps({
                    key: 0,
                    size: item.ui?.linkLeadingAvatarSize || props.ui?.linkLeadingAvatarSize || ui.value.linkLeadingAvatarSize()
                  }, item.avatar, {
                    class: ui.value.linkLeadingAvatar({ class: [props.ui?.linkLeadingAvatar, item.ui?.linkLeadingAvatar], active, disabled: !!item.disabled })
                  }), null, 16, ["size", "class"])) : item.icon ? (openBlock(), createBlock(_sfc_main$9, {
                    key: 1,
                    name: item.icon,
                    class: ui.value.linkLeadingIcon({ class: [props.ui?.linkLeadingIcon, item.ui?.linkLeadingIcon], active, disabled: !!item.disabled })
                  }, null, 8, ["name", "class"])) : createCommentVNode("", true)
                                                      ...
                                                      if (_push8) {
                                                        _push8(ssrRenderComponent(_sfc_main$c, mergeProps({ ref_for: true }, childSlotProps, {
                                                          ...
                                                          default: withCtx((_5, _push9, _parent9, _scopeId8) => {
                                                            if (_push9) {
                                                              if (childItem.icon) {
                                                                _push9(ssrRenderComponent(_sfc_main$9, {
                                                                  name: childItem.icon,
                                                              ...
                                                              return [
                                                                childItem.icon ? (openBlock(), createBlock(_sfc_main$9, {
                                                                  key: 0,
                                                                  name: childItem.icon,
                                                                  class: ui.value.childLinkIcon({ class: [props.ui?.childLinkIcon, item.ui?.childLinkIcon], active: childActive })
                                                                }, null, 8, ["name", "class"])) : createCommentVNode("", true),
                                                                createVNode("span", {
                                                                  ...
                                                                  childItem.target === "_blank" && __props.externalIcon !== false ? (openBlock(), createBlock(_sfc_main$9, {
                                                                    key: 0,
                                                                    name: typeof __props.externalIcon === "string" ? __props.externalIcon : unref(appConfig2).ui.icons.external,
                                                                    class: ui.value.childLinkLabelExternalIcon({ class: [props.ui?.childLinkLabelExternalIcon, item.ui?.childLinkLabelExternalIcon], active: childActive })
                                                                  }, null, 8, ["name", "class"])) : createCommentVNode("", true)
                                                ...
                                                if (_push7) {
                                                  _push7(ssrRenderComponent(_sfc_main$c, mergeProps({ ref_for: true }, childSlotProps, {
                                                    ...
                                                    default: withCtx((_4, _push8, _parent8, _scopeId7) => {
                                                      if (_push8) {
                                                        if (childItem.icon) {
                                                          _push8(ssrRenderComponent(_sfc_main$9, {
                                                            name: childItem.icon,
                                                            class: ui.value.childLinkIcon({ class: [props.ui?.childLinkIcon, item.ui?.childLinkIcon], active: childActive })
...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme), ...appConfig2.ui?.slideover || {} })({
...
export { _imports_0 as _, _sfc_main$2 as a, _sfc_main$b as b, _sfc_main$9 as c, _sfc_main as d, useColorMode as u };
//# sourceMappingURL=composables-B3jwHpQ6.mjs.map
